...
class ResNetClassifier(nn.Module):
    def __init__(self, resnet_version=None, num_classes=1): # 1 => binary classifier
...
if __name__ == "__main__":
    ...
    argParser.add_argument("--backbone", type=str, default="resnet50", choices=["resnet18", "resnet34", "resnet50", "resnet101"])
    ...
    ds = CelebA(root=data_dir, split='all', download=True, transform=transforms.ToTensor())
