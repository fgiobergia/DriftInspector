...
def init_detectors(overall_detectors_args=None):
    ...
    if overall_detectors_args == {}:
        ...
        overall_detectors_args = {
            "hddma_drift_confidence": [0.0001],  # 0.0002,  0.002
            "ddm_min_num_instances": [4000],  # 500, 1000, 2000, 8000
            "adwin_delta": [0.001],  # 0.0002,  0.002
            "eddm": None,
            "chi2": [0.001, 0.01, 0.25, 0.05],  # pvalue
            "fet": [0.001, 0.01, 0.25, 0.05],  # pvalue
            "kswin_window_size": [1000],  # 500, 1000, 2000, 8000, 2000
            "pagehinkley_min_num_instances": [4000],  # 500, 1000, 2000, 8000, 2000,
        }
    params = {}
